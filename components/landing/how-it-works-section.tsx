...
export function HowItWorksSection() {
  return (
    <div className="flex flex-col items-center justify-center mt-[75px] md:mt-[451px]">
      ...
      <div className="mt-5 md:mt-[80px] mb-[36px] flex flex-col md:flex-row items-center justify-center gap-x-[75px] gap-y-[43px] md:gap-y-0">
        ...
        >
          ...
          />
          <div className="flex items-center justify-between gap-x-[51px]">
            <p className="w-36 md:w-[205px] font-quantico font-normal text-[12px] md:text-[16px] md:leading-[24px] md:tracking-[0.15em] text-white ml-[22px] md:ml-[34px]">
