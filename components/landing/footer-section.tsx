  ...
  return (
    <footer className="relative font-roboto-flex w-full bg-[#0F1619] py-8 px-4 lg:px-8 flex items-center justify-between z-10">
      ...
      <div className="flex items-center gap-x-12">
        <a href="#" className="text-white text-[12px] lg:text-[16px] hover:underline">Terms</a>
        <a href="#" className="text-white text-[12px] lg:text-[16px] hover:underline">Privacy</a>
        <a href="#" className="text-white text-[12px] lg:text-[16px] hover:underline">Contact</a>
      </div>
    </footer>
  )
}
